...
REQUIRED = {
    ...
    # G9 promoted per the M285 decision evidence (three green
    # gpu-cuda-golden runs on the governed self-hosted GPU lane).
    "G9": ("cpu_gpu_deterministic_match", "implemented", True),
