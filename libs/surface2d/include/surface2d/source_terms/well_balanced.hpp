...
// the exact same pairing for the device.
[[nodiscard]] SCAU_HD inline WellBalancedEdgePairing well_balanced_edge_pairing(
...
[[nodiscard]] SCAU_HD inline core::Real well_balanced_boundary_pressure(
